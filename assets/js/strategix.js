...
let cards = shuffle([
  {
    ...
    description:
      "Incomplete, outdated, or inconsistent data can affect system performance and accuracy.",
    category: "Challenges",
  },
  {
    title: "User Adoption Resistance",
    description:
      "Employees or customers may be hesitant to trust or use new technologies.",
    category: "Challenges",
  },
  {
    title: "Integration Complexity",
    description:
      "Difficulty in connecting the solution with existing systems and workflows.",
    category: "Challenges",
  },
  {
    title: "Data Privacy",
  ...
  },
  {
    ...
    description:
      "Working with financial, people, or other resource contraints to implement the solution.",
    category: "Challenges",
  },
  {
    title: "Unclear success critieria",
    description:
      "Uncertainty about the project's goals and/or success measurement criteria.",
    category: "Challenges",
  },
  {
    title: "Explanability gaps",
    description:
      "Users report difficulty understanding how AI decisions are made.",
    category: "Challenges",
  },
  {
  ...
  },
  {
    ...
    description:
      "Improve usability and accessibility to ensure a seamless interaction for users.",
    category: "Objectives",
  },
  {
    title: "Reduce Costs",
    description:
      "Lower operational expenses by optimizing resources and automating processes.",
    category: "Objectives",
  },
  {
    title: "Ensure Compliance",
    description:
      "Meet regulatory and policy requirements to mitigate legal and security risks.",
    category: "Objectives",
  },
  {
    title: "Increase Revenue",
    description:
      "Drive growth through better decision-making, new opportunities, and improved customer engagement.",
    category: "Objectives",
  },
  {
  ...
  },
  {
    ...
    description:
      "Enable business growth by creating adaptable and scalable solutions.",
    category: "Objectives",
  },
  {
  ...
  },
  {
    ...
    description:
      "Automation streamlines operations and frees up employee time.",
    category: "Outcomes",
  },
  {
    title: "Reduce response times",
    description:
      "Common queries and requests are managed faster, allowing teams to focus on strategic initiatives.",
    category: "Outcomes",
  },
  {
  ...
  },
  {
    ...
    description:
      "Employees are able to support larger and/or more complex workloads.",
    category: "Outcomes",
  },
  {
  ...
  },
  {
    ...
    description:
      "Sustems or processes are more robust and adaptable to unexpected challenges.",
    category: "Outcomes",
  },
  {
    title: "Improved user trust",
    description:
      "Users feel confident in the system's fairness, transparency, and reliability.",
    category: "Outcomes",
  },
  {
    title: "Increased revenue streams",
    description:
      "The system identifies or unlocks new opportunities for generating income.",
    category: "Outcomes",
  },
  {
    title: "Higher customer satisfaction",
    description:
      "Improved services lead to happier customers and greater lifetime customer value.",
    category: "Outcomes",
  },
  {
    title: "Manager",
  ...
  },
  {
    ...
    description:
      "Maintains technical infrastructure and ensures system security.",
    category: "Stakeholders",
  },
  {
  ...
  },
  {
    title: "End User",
    description:
      "Interacts with the system daily and relies on its functionality.",
    category: "Stakeholders",
  },
  {
    title: "Process Owner",
  ...
  },
  {
    ...
    description:
      "Ensures organizational processes meet legal and regulatory requirements",
    category: "Stakeholders",
  },
  {
    title: "Responsible AI Group",
    description:
      "Provides insights and/or approval on ethical, fair, and accountable use of AI technologies.",
    category: "Stakeholders",
  },
  {
    title: "Director",
    description:
      "Sets departmental strategies and ensures resources are allocated effectively.",
    category: "Stakeholders",
  },
  {
    title: "Executive",
    description:
      "Defines organizational vision and strategy, approves high-level decisions.",
    category: "Stakeholders",
  },
  {
    title: "Compliance regulation update",
    description:
      "New legal requirements force adjustments to the system for compliance.",
    category: "Wildcard",
  },
  {
    title: "Bias in AI outputs",
    description:
      "The agent system is found to unfairly show favor certain employee groups",
    category: "Wildcard",
  },
  {
    title: "Upstream service downtime",
    description:
      "Temporary technical glitches in a dependant service cause reliability and/or availability issues.",
    category: "Wildcard",
  },
  {
...
function drawCard() {
  ...
  cardElement.setAttribute(
    "data-priority",
    priorityLevels[card.category] || "No priority provided"
  );
...
document.querySelectorAll(".nested-zone, .zone.NotRelevant").forEach((zone) => {
  ...
  zone.addEventListener("drop", (e) => {
    ...
    if (
      (data.category !== "Wildcard" && allowedCategories.includes(zone.closest(".zone").dataset.category)) ||
      zone.classList.contains("NotRelevant") ||
      (zone.closest(".zone").classList.contains("Wildcard") && data.category === "Wildcard")
    ) {
      // 1. Remove the card from all other categories first
      Object.keys(placedCards).forEach((category) => {
        placedCards[category] = placedCards[category].filter(
          (card) => card.title !== data.title
        );
      ...
      document
        .querySelectorAll(".nested-zone .card, .zone.NotRelevant .card")
      ...
      if (zone.classList.contains("NotRelevant")) {
        ...
        if (
          !placedCards["Not Relevant"].some((card) => card.title === data.title)
        ) {
        ...
        document
          .querySelectorAll(".nested-zone .card")
          .forEach((existingCard) => {
            if (existingCard.textContent.trim() === data.title) {
              console.log(
                `Removing card from previous zone: ${existingCard.textContent.trim()}`
              );
        ...
        document
          .querySelectorAll(".nested-zone .card, .zone .card")
          .forEach((existingCard) => {
            if (existingCard.textContent.trim() === data.title) {
              existingCard.remove();
            }
        ...
        console.log(
          `Applying border color for category: ${category}, color: ${
            categoryBorderColors[category] || "black"
          }`
        );
        const styleSheet = document.styleSheets[0];
        styleSheet.insertRule(
          `.card.${data.category} { border-left: 10px solid ${
            categoryBorderColors[data.category] || "black"
          } !important; }`,
        ...
        const originalCard = Array.from(cardList.children).find((card) =>
          card.textContent.includes(data.title)
        );
        if (originalCard) {
...
function checkAllCardsPlaced() {
  ...
  console.log(
    `Placed Cards: ${totalPlacedCards} / Total Drawn: ${cards.length}`
  );
  ...
  if (
    cards.length === 0 &&
    totalPlacedCards ===
      Object.keys(placedCards).reduce(
        (sum, cat) => sum + placedCards[cat].length,
        0
      )
  ) {
...
function checkInputs() {
  ...
  document.getElementById("proceed-to-finalization").style.display = allValid
    ? "block"
    : "none";
}
...
function collectPlaybookData() {
  ...
  document.querySelectorAll("#stakeholders-cards .card").forEach((card) => {
    const priority =
      card.getAttribute("data-priority") || "No priority provided"; // Capture priority
  ...
  document.querySelectorAll("#objectives-cards .card").forEach((card) => {
    const priority =
      card.getAttribute("data-priority") || "No priority provided";
  ...
  document.querySelectorAll("#challenges-cards .card").forEach((card) => {
    const classification =
      card.getAttribute("data-priority") || "No classification provided";
  ...
  document
    .querySelectorAll("#outcomes-cards .card-wrapper")
    .forEach((wrapper) => {
      const card = wrapper.querySelector(".card");
      const measurement =
        wrapper.querySelector(".measurement-dropdown")?.value ||
        "Not specified";
      const classification =
        card.getAttribute("data-priority") || "No classification provided"; // Optional classification
...
Outcomes:
${data.outcomes
  .map((o) => `- ${o.title}: ${o.input} (Measured using ${o.measurement})`)
  .join("\n")}
...
function collectPrompt() {
  ...
  const stakeholderCards = document.querySelectorAll(
  ...
  const prompt = `
        ...
        ${
          businessCaseData.stakeholders.length > 0
            ? businessCaseData.stakeholders
                .map((s) => `- ${s.title} (**Priority: ${s.input}**)`)
                .join("\n")
            : "**None provided**"
        }
        ...
        ${
          businessCaseData.objectives.length > 0
            ? businessCaseData.objectives
                .map((o) => `- ${o.title} (**Priority: ${o.input}**)`)
                .join("\n")
            : "**None provided**"
        }
        ...
        ${
          businessCaseData.challenges.length > 0
            ? businessCaseData.challenges
                .map((c) => `- ${c.title} (**Severity: ${c.input}**)`)
                .join("\n")
            : "**None provided**"
        }
        ...
        ${
          businessCaseData.outcomes.length > 0
            ? businessCaseData.outcomes
                .map(
                  (o) =>
                    `- ${o.title} (**Measurement: ${o.measurement}**, **Classification: ${o.input}**)`
                )
                .join("\n")
            : "**None provided**"
        }
...
document.getElementById("download-pdf").addEventListener("click", () => {
  ...
  if (!contentDiv) {
    alert(
      "Error: The business case content is missing. Please generate the report before downloading."
    );
    return;
  }
  ...
  let textContent =
    contentDiv.innerText || contentDiv.textContent || "No content available.";
